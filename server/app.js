...
const bapRoutes = require('./routes/bap');
...
const generateDocumentsRoutes = require('./routes/generate-documents');
...
app.use('/api/generate-documents', generateDocumentsRoutes);
